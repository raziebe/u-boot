 ...
 */
static float calc_lun_capacity(struct ufs_unit_cfg_parameters *unit,
 ...
 * Return: Command status.
 */
static int idn_read(struct ufs_hba *hba, int idn, int lun)
{
	void *desc = NULL;
	...
	case QUERY_DESC_IDN_POWER:
		...
		if (!ufshcd_query_desc_power(hba, lun, desc)) {
...
static int ufs_tool_query(int lun, int idn)
{
	struct ufs_hba *hba;
